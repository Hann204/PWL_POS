...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['authorize:ADM,MNG,STF'])->group(function () {
        Route::get('/Transaksi', [TransaksiController::class, 'index']);          // menampilkan halaman awal stok
        Route::post('/Transaksi/list', [TransaksiController::class, 'list']);      // menampilkan data stok dalam bentuk json untuk datatables
        Route::get('/Transaksi/create', [TransaksiController::class, 'create']);   // menampilkan halaman form tambah stok
        Route::get('/Transaksi/create_ajax', [TransaksiController::class, 'create_ajax']);
        Route::post('/Transaksi/ajax', [TransaksiController::class, 'store_ajax']);
        Route::post('/Transaksi', [TransaksiController::class, 'store']);         // menyimpan data stok baru
        Route::get('/Transaksi/import', [TransaksiController::class, 'import']);
        Route::post('/Transaksi/import_ajax', [TransaksiController::class, 'import_ajax']);
        ...
        Route::get('/Transaksi/{id}', [TransaksiController::class, 'show']);       // menampilkan detail stok
        Route::get('/Transaksi/{id}/edit', [TransaksiController::class, 'edit']);  // menampilkan halaman form edit stok
        Route::put('/Transaksi/{id}', [TransaksiController::class, 'update']);     // menyimpan perubahan data stok
        Route::get('/Transaksi/{id}/edit_ajax', [TransaksiController::class, 'edit_ajax']);
        Route::put('/Transaksi/{id}/update_ajax', [TransaksiController::class, 'update_ajax']);
        Route::get('/Transaksi/{id}/delete_ajax', [TransaksiController::class, 'confirm_ajax']);
        Route::delete('/Transaksi/{id}/delete_ajax', [TransaksiController::class, 'delete_ajax']);
        Route::delete('/Transaksi/{id}', [TransaksiController::class, 'destroy']); // menghapus data stok
    });
